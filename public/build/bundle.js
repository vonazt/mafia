...
var app = (function () {
    ...
    */
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h1, "class", "svelte-1lzrz1j");
    			add_location(h1, file, 39, 2, 548);
    			attr_dev(a, "href", "https://svelte.dev/tutorial");
    			add_location(a, file, 42, 4, 605);
    			add_location(p, file, 40, 2, 583);
    			attr_dev(button, "class", "svelte-1lzrz1j");
    			add_location(button, file, 45, 2, 711);
    			attr_dev(main, "class", "svelte-1lzrz1j");
    			add_location(main, file, 38, 0, 539);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ io: lib$1, socket, name, handleSubmit });
